...
Remember, you're SMS database is likely empty assuming you're using the emulator, so before trying to run this, you should populate it with some messages first.
